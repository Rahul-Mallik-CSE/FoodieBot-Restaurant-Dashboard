              ...
              >
                ...
                {plan.popular && (
                  <div className="absolute top-4 right-4">
                    <Button className="bg-button text-primary text-xs font-semibold px-3 py-1 ">
                      Popular
                    </Button>
                  </div>
                )}
                ...
                <button
                  className={cn(
                    "w-full cursor-pointer py-2.5 rounded-xl text-sm font-semibold transition-all mb-5",
                    plan.buttonVariant === "red"
                      ? "bg-button text-white shadow-[0_0_12px_rgba(192,0,105,0.4)] hover:opacity-90"
